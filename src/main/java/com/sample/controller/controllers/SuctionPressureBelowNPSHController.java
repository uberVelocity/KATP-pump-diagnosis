...
public class SuctionPressureBelowNPSHController extends SceneController {
	public SuctionPressureBelowNPSHController(Controller controller) {
    ...
    public void setButtonActions() {
        ...
        yesButton.setOnAction(e -> {
            if(yesButton.getId().equals("yesButton")) {
                controller.getModel().getPump().check("suctionPressureBelowNPSH");
                controller.getModel().getPump().setSuctionPressureBelowNPSH(true);
        ...
        noButton.setOnAction(e -> {
            if(noButton.getId().equals("noButton")) {
                controller.getModel().getPump().check("suctionPressureBelowNPSH");
                controller.getModel().getPump().setSuctionPressureBelowNPSH(false);
                controller.getKsession().update(controller.getFactHandle(), controller.getModel().getPump());
                controller.getKsession().fireAllRules();
            }
        });
