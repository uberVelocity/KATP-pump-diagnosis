...
public class ExitPressureBelowThresholdController extends SceneController {

	public ExitPressureBelowThresholdController  (Controller controller) {
    ...
    public void setButtonActions() {
        ...
        noButton.setOnAction(e -> {
            if(noButton.getId().equals("noButton")) {
                controller.getModel().getPump().check("exitPressureBelowThreshold");
                controller.getModel().getPump().setExitPressureBelowThreshold(false);
                controller.getKsession().update(controller.getFactHandle(), controller.getModel().getPump());
                controller.getKsession().fireAllRules();
            }
        });
