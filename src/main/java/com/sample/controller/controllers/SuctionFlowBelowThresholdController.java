...
public class SuctionFlowBelowThresholdController extends SceneController {
	public SuctionFlowBelowThresholdController(Controller controller) {
    ...
    public void setButtonActions() {
        ...
        yesButton.setOnAction(e -> {
            if(yesButton.getId().equals("yesButton")) {
                controller.getModel().getPump().check("suctionFlowBelowThreshold");
                controller.getModel().getPump().setSuctionFlowBelowThreshold(true);
        ...
        noButton.setOnAction(e -> {
            if(noButton.getId().equals("noButton")) {
                controller.getModel().getPump().check("suctionFlowBelowThreshold");
                controller.getModel().getPump().setSuctionFlowBelowThreshold(false);
                controller.getKsession().update(controller.getFactHandle(), controller.getModel().getPump());
                controller.getKsession().fireAllRules();
            }
        });
