...
public class PropellerSpeedBelowThresholdController extends SceneController {
	public PropellerSpeedBelowThresholdController(Controller controller) {
    ...
    public void setButtonActions() {
        ...
        yesButton.setOnAction(e -> {
            if(yesButton.getId().equals("yesButton")) {
                controller.getModel().getPump().check("speedBelowNormal");
                controller.getModel().getPump().setSpeedBelowNormal(true);
        ...
        noButton.setOnAction(e -> {
            if(noButton.getId().equals("noButton")) {
                controller.getModel().getPump().check("speedBelowNormal");
                controller.getModel().getPump().setSpeedBelowNormal(false);
                controller.getKsession().update(controller.getFactHandle(), controller.getModel().getPump());
                controller.getKsession().fireAllRules();
            }
        });
