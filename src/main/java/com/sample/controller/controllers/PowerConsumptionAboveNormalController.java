...
public class PowerConsumptionAboveNormalController extends SceneController {
	public PowerConsumptionAboveNormalController(Controller controller) {
    ...
    public void setButtonActions() {
        ...
        yesButton.setOnAction(e -> {
            if(yesButton.getId().equals("yesButton")) {
                controller.getModel().getPump().check("powerConsumptionAboveNormal");
                controller.getModel().getPump().setPowerConsumptionAboveNormal(true);
        ...
        noButton.setOnAction(e -> {
            if(noButton.getId().equals("noButton")) {
                controller.getModel().getPump().check("powerConsumptionAboveNormal");
                controller.getModel().getPump().setPowerConsumptionAboveNormal(false);
                controller.getKsession().update(controller.getFactHandle(), controller.getModel().getPump());
                controller.getKsession().fireAllRules();
            }
        });
